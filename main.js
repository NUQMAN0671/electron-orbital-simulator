...
// --- Drawer Push/Pull Handle Toggle ---
const drawerBtn = document.getElementById('btn-toggle-drawer');
const drawerEl = document.getElementById('periodic-drawer');
...
drawerBtn.addEventListener('click', () => {
    ...
    const isCollapsed = drawerEl.classList.contains('collapsed');
    
    drawerArrow.innerText = isCollapsed ? '▲' : '▼';
    drawerText.innerText = isCollapsed ? 'Expand Periodic Table' : 'Minimize Periodic Table';

    // Trigger canvas resize smoothly after CSS transition completes
